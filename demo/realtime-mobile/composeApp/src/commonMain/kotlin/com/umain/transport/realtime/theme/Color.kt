...
// SL "tunnel" dark — a deeper, slightly blue-tinted black so the line
// reds/greens/blues read as wayfinding signage instead of muted UI accents.
internal val BackgroundDark = Color(0xFF0A0E12)
internal val OnBackgroundDark = Color(0xFFE8EBEE)
internal val SurfaceDark = Color(0xFF161B21)
internal val OnSurfaceDark = Color(0xFFE8EBEE)
internal val SurfaceVariantDark = Color(0xFF1F252C)
internal val OnSurfaceVariantDark = Color(0xFFB6BEC8)
